...
export function loadConfig() {
    ...
    return {
        ...
        openRouterModels: filterFreeOnly(splitCSV(core.getInput('openrouter_models') ||
            'deepseek/deepseek-r1:free,meta-llama/llama-4-maverick:free,google/gemini-2.0-flash-exp:free'), core.getInput('openrouter_free_only') === 'true', 'OpenRouter'),
        ...
        kiloModels: filterFreeOnly(splitCSV(core.getInput('kilocode_models') ||
            'kilo-auto/balanced:free,kilo-auto/frontier:free'), core.getInput('kilocode_free_only') === 'true', 'Kilo'),
