...
import { buildCombinedChain, probeModels } from './model-chain.js';
...
function makeMockClient(probeResult, delayMs = 0) {
    return {
...
function makeVariableLatencyClient(latencies, probeResult = true) {
    return {
...
function makeClients(model, client) {
    const clients = {
